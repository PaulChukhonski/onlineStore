    ...
    <main class="main">
        <form class="form" method="post" action="Controller">
            ...
            <div class="form_group">
                ...
                <input class="form_input" type="email" name="email" value="<c:out value="${email}"></c:out>" required>
            </div>
            <div class="form_group">
                <label class="form_label">Address</label>
                <input class="form_input" type="text" name="address" value="<c:out value="${address}"></c:out>" required>
            </div>
            <div class="form_group">
                <label class="form_label">Password</label>
                <input class="form_input" type="password" name="password_1" required>
            </div>
            <div class="form_group">
                <label class="form_label">Confirm Password</label>
                <input class="form_input" type="password" name="password_2" required>
            </div>
            <div class="form_group">
                <button>Register</button>
            </div>
            <p>
                <label class="form_label">Already have an account?</label> <a href="Controller?page=login">Log in now</a>
            </p>
        </form>
    </main>
